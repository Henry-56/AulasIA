...
"[project]/app/api/simulation/analyze/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        const course = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].course.findUnique({
            where: {
                id: courseId
            },
            include: {
        ...
        const session = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].classSession.create({
            data: {
                courseId,
                duration: 15,
                videoGenerated: true,
...
async function saveAnalysisToDatabase(sessionId, analysisData) {
    try {
        // Update session as analyzed
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].classSession.update({
            where: {
                id: sessionId
            },
            data: {
        ...
        const metrics = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].sessionMetrics.create({
            data: {
                sessionId,
        ...
        if (analysisData.students && Array.isArray(analysisData.students)) {
            const session = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].classSession.findUnique({
                where: {
                    id: sessionId
                },
                include: {
            ...
            if (session?.course.students) {
                for (const studentData of analysisData.students){
                    ...
                    if (student) {
                        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].studentMetric.create({
                            data: {
                                sessionId,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7be07f33._.js.map